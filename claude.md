# Claude Assistant Guidelines for Statistical Modeling Project

Hello Claude! When working on this repository, please strictly adhere to the following project directives and constraints:
